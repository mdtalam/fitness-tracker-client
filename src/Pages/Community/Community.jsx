...
import { FaThumbsDown, FaThumbsUp } from "react-icons/fa"; // React icons for voting
...
const Community = () => {
  ...
  const handleVote = async (postId, voteType) => {
    ...
    try {
      ...
      const userId = user?._id; // Assuming user info is stored in `user`
      await axiosSecure.put(endpoint, { userId });

      // Refetch posts after voting
      await refetch();
    } catch (error) {
      Swal.fire({
        icon: "error",
